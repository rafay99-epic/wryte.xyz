...
/**
 * Desktop port of the web app's `(app)/layout.tsx` shell: animated sidebar,
 * header, command palette, focus mode, global shortcuts, and the auth
 * overlay. Identical composition; routing comes from react-router.
 */
